...
public class DyingPlayerState : MonoBehaviour {
	...
	private Vector3 rndRotAxis;
	private float rndRotSpeed;
	public int rotFactor = 200;
	...
	void Start () {
		...
		rndRotAxis = Random.onUnitSphere;
		rndRotSpeed = Random.value;
	}
...
//		Debug.Log (dist*100);
		...
		transform.Rotate (rndRotAxis,rotFactor*rndRotSpeed*Time.deltaTime);
